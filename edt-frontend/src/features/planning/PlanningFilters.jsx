    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 bg-muted/40 border border-border/60 rounded-lg p-3">
                ...
                <Button 
                    variant={hasAdvancedFiltersActive ? "secondary" : "outline"}
            ...
            {/* Filtres avancés */}
            {showAdvanced && (
                <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 bg-muted/20 border border-border/40 rounded-lg p-3 animate-in slide-in-from-top-2">
                    <Select
